    ...
    <div className="min-h-screen">
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-3xl">
          ...
          {/* Mission */}
          <section className="glass-card rounded-2xl p-8 mb-8 animate-slide-up">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
                <GraduationCap className="w-6 h-6 text-primary" />
              </div>
              <div>
                <h2 className="text-xl font-semibold mb-3">Student-Built for Students</h2>
          ...
          {/* Purpose */}
          <section className="glass-card rounded-2xl p-8 mb-8 animate-slide-up" style={{ animationDelay: "100ms" }}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
                <Target className="w-6 h-6 text-primary" />
              </div>
              <div>
                <h2 className="text-xl font-semibold mb-3">Focus on Learning, Not Automation</h2>
          ...
          {/* Disclaimer */}
          <section className="glass-card rounded-2xl p-8 mb-8 border-primary/30 animate-slide-up" style={{ animationDelay: "200ms" }}>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
